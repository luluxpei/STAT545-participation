...
For nicer graph, redefine ggplot so `geom_point` comes first and then `geom_line` follows (ggplot works sequentially).

### 2(d)

What's wrong with the following code? Fix it. <- x and y not specified within `aes` function.
