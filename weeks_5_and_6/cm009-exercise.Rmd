...
Yes; each row represents a single observation specified by Film, Race, Gender, and Words spoken.
...
experiment %>% complete(name, trt, rep) # considers all possible combinations of name, trt, rep
